...
public class quickSurvey {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div/div[4]/div[1]/div[3]/div[2]/img")).click();
		Thread.sleep(2000);
		...
		String expTitle = "Quick Survey App";

		if (actTitle.equals(expTitle)) {
			System.out.println("Quick Survey was opened successfully");
		} else {
			System.out.println("Quick Survey was not opened");
		};
...
//			System.out.println(actOfferName);
		String expOfferName = "Quick Survey";
...
//		System.out.println(currentYear);
		...
		if (actOfferName.equals(expOfferName) && actMonth.equals(expMonth) && actDate.equals(expDate)
			...
			System.out.println("Quick Survey callback is new");
			...
			System.out.println("There is no CallBack from Quick Survey");
		}
